...
const Hero = () => {
    return (
        <section className='container mx-auto px-20 md:px-36 lg:px-60'>
            <article className="font-mono mt-5">
                <picture>
                    <img src="/samurai.png" alt="" className='w-24 md:w-32 mx-auto' />
                </picture>
                <div>
                    <h2 className='my-5 text-center font-bold text-xl md:text-2xl lg:text-3xl text-slate-900'>Hello, my name is Syafiq Rizky Fauzi.</h2>
